...
import NewPostSideOver, {
  NewPostSideOverRef,
} from "../../components/newPostSideOver";

const Posts: NextPageWithLayout = () => {
  const { posts, loading } = usePostCollection();
  const sideOver = useRef<NewPostSideOverRef>(null);
  ...
  return (
    <>
      <div className="flex items-center justify-end mb-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <button
          type="button"
